...
class ImageUploadComponent extends Component {
    ...
    this.setState(
      ...
      async () => {
        await this.state.formData.forEach(async (item) => {
          ...
          // };
          await axios
            .post(`${eventsUrl}/${this.props.EventId}/eventPhoto`, item)
            .then((response) => {
              ...
              this.setState(
                ...
                () => {
                  this.props.enableTabs(3,this.props.EventId);
                  swal(success, {
                    icon: "success",
                  });
                }
  ...
  deleteImage = (id) => {
    ...
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`${eventsUrl}/${this.props.EventId}/eventPhoto/${id.split("/")[3]}`)
          .then((response) => {
